...
<div id="fre-post-project-2 step-post" class="fre-post-project-step step-wrapper step-post <?php echo $class_active;?>">
    ...
    <?php } ?>
    <div class="fre-post-project-box">
        <!-- Saving Privacy Notification - By: eK -->
        <div class="notice-first-login">
            <p>
                <i class="fa fa-warning"></i>Sharing confidential information can lead to privacy breaches. Protect yourself by keeping it private.
            </p>
        </div>
