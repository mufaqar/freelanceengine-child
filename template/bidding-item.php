    ...
    <div class="col-md-7 col-sm-12">
        <div class="col-content-bid col-content-bid-<?php echo $convert->ID ?>">
			...
			if ( $user_ID == $project->post_author ) {
				// NDA - By: eK
				$ek_nda = get_field('bid-nda', get_the_ID());
				if ( $ek_nda ) {
					echo '<a class="fre-normal-btn" id="' . get_the_ID() . '" href="' . $ek_nda['url'] . '">' . __( 'Download NDA', ET_DOMAIN ) . '</a>';
					if ( $convert->flag == 1 ) {
					...
					echo '<em><b>(The NDA has not been sent yet.)</b></em></br>';
				}
				// Connect Button
