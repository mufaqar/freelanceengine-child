...
<div class="fre-our-stories">
	<div class="container">
		<h2 id="title_story">What we offer</h2>
		<br/>
		<h3 id="title_start">We offer our services to (companies, academic institutes, research centres and Hospitals, Students).</h3>
		<div class="fre-jobs-online-more">
			<a class="fre-btn-o primary-color" href="/our-services">Our Services</a>
		</div>
	</div>
</div>
<!-- Motivation Message -->
