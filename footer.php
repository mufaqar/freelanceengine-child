        ...
        <div class="row">
            <div class="<?php echo $col ?>">
                <div class="fre-footer-logo">
                    ...
                    <a href="<?php echo home_url(); ?>" class="logo-footer"><?php echo '<img src="' . get_template_directory_uri() . '/img/logo-white.png"/>' ?></a>
                </div>
            </div>
            <div class="<?php echo $col; ?> ">
                <p class="text-copyright">
					<?php if ( $copyright ) {
						echo $copyright;
                        echo ' - Designed By: <a target="_blank" rel="designer" href="https://twitter.com/engkareemareed">eK</a>';
					}
                    else {
                        echo 'All Rights Reserved © Connect Platform ' . date( 'Y' ) . ' - Designed By: <a target="_blank" rel="designer" href="https://twitter.com/engkareemareed">eK</a>';
                    } ?>
                </p>
            </div>
        </div>
...
// get_template_part( 'template-js/modal', 'send-nda' );
// get_template_part( 'template-js/modal', 'nda-template' );
